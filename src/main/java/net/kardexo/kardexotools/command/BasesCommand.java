				...
				.then(Commands.argument("id", StringArgumentType.word())
					...
					.then(Commands.literal("reset")
						.then(Commands.argument("owner", EntityArgument.player())
							...
							.then(Commands.literal("exit")
								.executes(context -> setExitMessage(context.getSource(), StringArgumentType.getString(context, "id"), EntityArgument.getPlayer(context, "owner"), null)))
							.then(Commands.literal("both")
								.executes(context -> setBothMessages(context.getSource(), StringArgumentType.getString(context, "id"), EntityArgument.getPlayer(context, "owner"), null)))))
